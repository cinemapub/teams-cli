...
### Created by Peter Forret ( cinemapub ) on 2023-01-01
...
readonly script_created="2023-01-01"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="Send messages to MS Teams channels from CLI"
## some initialisation
action=""
script_prefix=""
script_basename=""
